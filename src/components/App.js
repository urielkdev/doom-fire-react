...
const fireRows = 80; // height
const fireColumns = 80; // width
        ...
        return (
            <div className="container-center">
                <div style={{textAlign: "center"}}>
                    ...
                    <button className="ui primary button" onClick={this.decreaseFireSource}>-</button>
                    <button className="ui primary button" onClick={this.destroyFireSource}>Min Fire</button>
                    <button className="ui primary button" onClick={this.createFireSource}>Max Fire</button>
                    <button className="ui primary button" onClick={this.increaseFireSource}>+</button>
                    <br />
